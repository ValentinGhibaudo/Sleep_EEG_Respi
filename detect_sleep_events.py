...
for subject in subjects:
    ...
    for event_type in ['spindle','slow_wave']: # loop on both types of events (spindles or slow waves)
        data = xr.load_dataarray(f'../preproc/{subject}_reref.nc') # slow-waves will be detected on reref data on average mastoid
        ...
        if event_type == 'spindle':
            ...
            destination_file = f'../event_detection/{subject}_spindles_reref.xlsx'
            ...
            destination_file = f'../event_detection/{subject}_slowwaves_reref.xlsx'
