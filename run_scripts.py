...
program_list = ['rsp_detection.py','rsp_tagging_by_sleep.py','rsp_stats.py','events_to_resp_features.py','events_stats.py','events_coupling.py','events_coupling_stats.py','events_coupling_figs.py','sigma_coupling.py','sigma_coupling_stats.py','sigma_coupling_means.py','sigma_coupling_figures.py']
